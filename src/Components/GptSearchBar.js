...
const GptSearchBar = () => {
  ...
  return (
    <div className='pt-[30%] sm:pt-[20%] md:pt-[12%] grid place-items-center mx-auto p-0 '>
        <form onSubmit={(e)=>e.preventDefault()} className='bg-black w-full p-0 sm:w-2/3 md:w-1/2 grid grid-cols-12 rounded-lg  ' >
            <input type='text' ref={serachText} className='m-5 rounded-md  md:p-2  col-span-10  md:rounded-lg text-center' placeholder={lang[language].gptSearchPlaceholder}/>
